...
**2026-09-26 — 최종 비교 시뮬레이션 실행 전 준비.** 위5cm WCC계열 콘크리트와 아래25cm 지지층의 온도·수분 네 상태를 계산한다. 인천2025년1–2월·7–8월의 동일 날씨에 반사율과 살수량을 바꿔 비교한다. **현재 준비 작업에서는 실제 연구 시뮬레이션을 실행하지 않았다. 추가 사용자 승인 필요.**
